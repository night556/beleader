...
// ChatStream sends a streaming chat completion request. Each content delta is
// passed to onChunk. The returned response has the fully accumulated Content and
// ToolCalls after the stream ends.
